export type TaskStatus = 'TASK_RECEIVED' | 'TASK_ANALYZING' | 'TASK_VALID' | 'TASK_ACCEPTED' | 'TASK_COMPLETED' | 'TASK_BLOCKED' | 'TASK_NOT_APPLICABLE' | 'TASK_NEEDS_CLARIFICATION' | 'TASK_FAILED' | 'TASK_CANCELLED';
export type CandidateStatus = 'CANDIDATE_NOT_CREATED' | 'CANDIDATE_GENERATING' | 'CANDIDATE_GENERATION_FAILED' | 'CANDIDATE_CREATED' | 'CANDIDATE_APPLIED' | 'CANDIDATE_EVALUATED' | 'CANDIDATE_ACCEPTED' | 'CANDIDATE_REJECTED' | 'CANDIDATE_ROLLED_BACK';
...
export type ReasonCode = 
    ...
    | 'SCOPE_ESCAPE_BLOCKED'
    | 'DESTRUCTIVE_OPERATION_BLOCKED'
    | 'FRAMEWORK_MIGRATION_BLOCKED'
