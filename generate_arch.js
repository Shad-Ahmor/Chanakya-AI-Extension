...
const archContent = `# MASTER ARCHITECTURE: Chanakya AI Enhancer
...
fs.writeFileSync('ARCHITECTURE/MASTER_ARCHITECTURE.md', archContent);
console.log('Generated ARCHITECTURE/MASTER_ARCHITECTURE.md');
